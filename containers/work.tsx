...
export default function Work() {
  return (
    <div className="flex w-full bg-background-start bg-cover overflow-hidden">
      <div className="w-0.5 bg-main rounded-full relative top-[45%] left-10 sm:left-[20%]">
        <div className="flex flex-col w-2 h-2 rounded-full absolute top-0 left-1/2 transform -translate-x-1/2 bg-main"></div>
      </div>
      <div className="work-container">
        <div className="flex flex-col pb-8 sm:w-full ">
